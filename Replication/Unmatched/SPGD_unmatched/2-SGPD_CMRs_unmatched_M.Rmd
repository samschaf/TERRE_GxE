...
summary(as.factor(meta_M$disease.state.ch1))
#            Control Parkinson's disease 
#                390                 566 

#subset betas
dim(betas_M <- betas_combat[,colnames(betas_combat) %in% meta_M$Sample_Name]) #424699    956
```
...
save(refCMR_medB_M, file="/home1/NEURO/schaffner/4-replication/Vallerga_2020/SGPD_refCMR_medB_M_unmatched.RData")
```
