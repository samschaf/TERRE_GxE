...
summary(as.factor(meta_F$disease.state.ch1))
#            Control Parkinson's disease 
#                468                 327 

#subset betas
dim(betas_F <- betas_combat[,colnames(betas_combat) %in% meta_F$Sample_Name]) #424699    795
```
...
save(refCMR_medB_F, file="/home1/NEURO/schaffner/4-replication/Vallerga_2020/SGPD_refCMR_medB_F_unmatched.RData")
```
