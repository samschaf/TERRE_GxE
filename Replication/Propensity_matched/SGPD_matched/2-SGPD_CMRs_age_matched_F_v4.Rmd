...
#Meta data
meta <- read.csv("~/4-replication/Vallerga_2020/validation_matched/female/TERRE_SGPD_meta_F_matched_probit.csv")
meta_F <- meta[meta$cohort=="SGPD",]

summary(as.factor(meta_F$PD))
#   Case Control 
#    201     199 

#subset betas
dim(betas_F <- betas_combat[,colnames(betas_combat) %in% meta_F$Sample_Name]) #424699    400
```
...
save(refCMR_medB_F, file="/home1/NEURO/schaffner/4-replication/Vallerga_2020/validation_matched/female/SGPD_matched_refCMR_medB_F_probit.RData")
```
