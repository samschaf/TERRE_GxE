...
meta_F_PEG1 <- meta_F[meta_F$cohort=="PEG1",]

summary(as.factor(meta_F_PEG1$PD))
#   Case Control 
#     46      54 

#subset betas
dim(betas_F <- betas_combat[,colnames(betas_combat) %in% meta_F_PEG1$Sample_Name]) #424263    100
```
...
save(refCMR_medB_F, file="/home1/NEURO/schaffner/4-replication/Chuang_2017/validation_matched/female/PEG1_matched_with_TERRE_refCMR_medB_F_v4.RData")
```
